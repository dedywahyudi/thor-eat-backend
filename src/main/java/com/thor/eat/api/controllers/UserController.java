...
public class UserController {
    ...
    public User get(@PathVariable Long id) throws ThorEarlyException {
    ...
    @Transactional
    public User create(@Validated({ValidationGroup.Create.class, Default.class}) @RequestBody User entity)
    ...
    @Transactional
    public User update(@PathVariable Long id, @Validated(Default.class) @RequestBody User entity)
            throws ThorEarlyException  {
