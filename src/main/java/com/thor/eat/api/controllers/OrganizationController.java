...
/**
 * The organization REST controller. Is effectively thread safe.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
...
public class OrganizationController {
    ...
    protected void checkConfiguration() {
        Helper.checkConfigNotNull(organizationService, "organizationService");
    }
    ...
    public Organization get(@PathVariable Long id) throws ThorEarlyException {
    ...
    @Transactional
    public Organization create(@Validated({ValidationGroup.Create.class, Default.class}) @RequestBody Organization entity)
    ...
    @Transactional
    public Organization update(@PathVariable Long id, @Validated(Default.class) @RequestBody Organization entity)
            throws ThorEarlyException  {
        return organizationService.update(id, entity);
    }
    ...
    public SearchResult<Organization> search(@ModelAttribute OrganizationSearchCriteria criteria,
                                      @ModelAttribute Paging paging) throws ThorEarlyException  {
        if (paging.getSortColumn() == null) {
            paging.setSortColumn("name");
        }
        return organizationService.search(criteria, paging);
    }
}
